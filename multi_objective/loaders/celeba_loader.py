...
class CelebA(data.Dataset):
    def __init__(self, split, task_ids=[], root='D:/pyprojects/PFL2/data/celeba', dim=[64, 64], augmentations=None, **kwargs):
        """__init__
        ...
        for i, img in enumerate(self.all_files):
            self.all_files[i] = img.replace('\\', '/')
