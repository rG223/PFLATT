...
class Upsampler(nn.Module):
    ...
    def forward(self, batch):
        ...
        # return self.child_model(dict(data=x), batch['alpha'])
...
class AttentionMethod(BaseMethod):
...
class YOTOMethod(BaseMethod):
    ...
    def __init__(self, objectives, alpha, lamda, dim, n_test_rays, **kwargs):
        ...
        model = model_from_dataset(method='yoto', dim=dim, **kwargs)
        self.model = model.cuda()
