...
from models import FullyConnected, MultiLeNet, EfficientNet, ResNet, MultiLeNet_attention, MultiLeNet_yoto
...
def model_from_dataset(dataset, **kwargs):
    if dataset == 'adult':
        ...
        if kwargs['method'] == 'preatt':
            return MultiLeNet_attention(**kwargs)
        elif kwargs['method'] == 'yoto':
            return MultiLeNet_yoto(**kwargs)
        else:
