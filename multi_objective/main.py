...
from methods import HypernetMethod, ParetoMTLMethod, SingleTaskMethod, COSMOSMethod, MGDAMethod, UniformScalingMethod, AttentionMethod, YOTOMethod
...
def method_from_name(method, **kwargs):
    ...
    elif 'preatt' in method:
        return AttentionMethod(**kwargs)
    elif 'yoto' in method:
        return YOTOMethod(**kwargs)
...
def parse_args():
    ...
    elif args.method == 'preatt':
        settings.update(s.preatt)
    elif args.method == 'yoto':
        settings.update(s.yoto)
